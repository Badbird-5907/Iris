...
public class PacketListeners implements AtlasListener {
    ...
    public void onEvent(PacketSendEvent event) {
        ...
        Iris.getInstance().getProfiler().start("event:PacketSendEvent");
        ...
        Iris.getInstance().getProfiler().stop("event:PacketSendEvent");
    }
    ...
    public void onEvent(PacketReceiveEvent event) {
        ...
        Iris.getInstance().getProfiler().start("event:PacketReceiveEvent");
        PlayerData data = Iris.getInstance().getDataManager().getPlayerData(event.getPlayer().getUniqueId());
                ...
                case Packet.Client.BLOCK_DIG: {
                    ...
                    switch (blockDig.getAction()) {
                        ...
                        case STOP_DESTROY_BLOCK:
                            ...
                            data.getLastBlockBreakStop().reset();
                            break;
                        case RELEASE_USE_ITEM:
                            data.getLastStopUsingItem().reset();
                            break;
                    }
                    break;
                }
        ...
        Iris.getInstance().getProfiler().stop("event:PacketReceiveEvent");
    }
