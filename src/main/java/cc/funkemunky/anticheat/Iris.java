...
public class Iris extends JavaPlugin {
    ...
    public void onDisable() {
        ...
        Atlas.getInstance().getEventManager().unregisterListener(new FunkeListeners());
        Atlas.getInstance().getEventManager().unregisterListener(new PacketListeners());
    ...
    private void registerCommands() {
        Atlas.getInstance().getFunkeCommandManager().addCommand(this,new IrisCommand());
    }
            ...
            try {
                ...
                if(clazz.isAnnotationPresent(Init.class)) {
                    ...
                    if (obj instanceof Listener) {
                        ...
                        Atlas.getInstance().getEventManager().registerListeners((AtlasListener) obj,this);
                    }
